...
export default {
  ...
  methods: {
    toDetail(item) {
      ...
      //   nw.Window.open(
      //     "chrome-extension://kbddllogcbdndhohpkalekljdlkohhco/index.html#/orderdetail?id=" +
      //       item.ID +
      //       "&gameName=" +
      //       item.BIG_GAME_NAME,
      //     {
      ...
      // } else {
      //   window.open(
      //     "#/orderdetail?id=" + item.ID + "&gameName=" + item.BIG_GAME_NAME
      //   );
      // }
